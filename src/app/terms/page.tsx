      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          <section className="legal-section">
            ...
            <p>
              By accessing and using the Pingaksh Innovations website and services, you accept and agree 
          ...
          <section className="legal-section">
            ...
            <p>
              Pingaksh Innovations provides cutting-edge technology solutions in the fields of:
            </p>
            <ul>
              <li>Artificial Intelligence and Machine Learning</li>
              <li>Robotics and Automation</li>
              <li>Internet of Things (IoT) Solutions</li>
              <li>Space Research and Technology</li>
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              Pingaksh Innovations and are protected by international copyright, trademark, patent, 
              trade secret, and other intellectual property laws.
            </p>

            <h3>5.2 Your Intellectual Property</h3>
            <p>
              You retain ownership of any intellectual property rights you hold in content you submit 
              to our services. By submitting content, you grant us a worldwide, non-exclusive license 
          ...
          <section className="legal-section">
            ...
            <p>
              We strive to maintain the availability of our services but do not guarantee uninterrupted 
          ...
          <section className="legal-section">
            ...
            <p>
              For paid services, payment terms will be specified in separate agreements. All fees are 
              non-refundable unless otherwise stated. We reserve the right to change our pricing with 
              appropriate notice.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              To the maximum extent permitted by law, Pingaksh Innovations shall not be liable for any 
          ...
          <section className="legal-section">
            ...
            <p>
              You agree to defend, indemnify, and hold harmless Pingaksh Innovations and its officers, 
              directors, employees, and agents from and against any claims, damages, obligations, losses, 
              liabilities, costs, or debt arising from your use of our services.
            </p>
          </section>
