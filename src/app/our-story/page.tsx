          ...
          <div className="our-story-content">
            <div className="story-section">
              <p className="story-text">
                At Pingaksh Innovation, our journey began with a bold vision to build a future shaped by cutting-edge technology, strategic thinking, and meaningful impact. Founded with a passion for innovation in robotics, AI, space research, and digital transformation, we set out to bridge the gap between ideas and real-world solutions.
              </p>
            </div>
